...
public class PanelPlan extends javax.swing.JPanel {
    ...
    public PanelPlan() {
        ...
        FrameUtils.addEnterEvent(jtxtPrecio, this::createPlanEvent);
    }
    ...
    public void refreshPlanes() {
        ...
        List<JPanel> planesInPanel = listaPlanes.stream().map(currentPlan -> {
            ...
            planName.setBounds(20, 20, width, 20);

            Typography detail = new Typography();
            detail.setText(String.format("S/ %d \nDuración de %d días", currentPlan.getPrice(),
                    currentPlan.getDurationDays()));
            planName.setBounds(20, 100, width, 40);

            panel.setBounds(0, 200 * i, width, height);
            return panel;
    ...
    private void initComponents() {
        ...
        jpnlInterfaz.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 338, 522));
        ...
        jpnlInterfaz.add(planesPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 380, 630));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jpnlInterfaz, javax.swing.GroupLayout.PREFERRED_SIZE, 790,
                                javax.swing.GroupLayout.PREFERRED_SIZE));
